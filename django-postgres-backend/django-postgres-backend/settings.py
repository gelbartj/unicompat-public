"""
Django settings for unicodesaywhat project.
...
ROOT_URLCONF = 'unicodesaywhat.urls'
...
WSGI_APPLICATION = 'unicodesaywhat.wsgi.application'
...
if USE_S3:
    ...
    STATICFILES_STORAGE = 'unicodesaywhat.storage_backends.StaticStorage'
    # s3 public media settings
    PUBLIC_MEDIA_LOCATION = 'media'
    MEDIA_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/{PUBLIC_MEDIA_LOCATION}/'
    DEFAULT_FILE_STORAGE = 'unicodesaywhat.storage_backends.PublicMediaStorage'
else:
    STATIC_URL = '/static/'
